...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ENGINESIX', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://enginesix.tech/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '打工人社区', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '打 工 人 社 区', // 站点标题 ，被notion中的页面标题覆盖
